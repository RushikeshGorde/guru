...
import menu from '../../menu.json'; // Ensure menu.json contains an array of objects with { title: string, path: string } structure
            ...
            <Grid item xs={3} sx={{ display: 'flex', alignItems: 'center' }}>
              <Box className="Icon-ani">
                <ul>
                  ...
                  <li>
                    <Link to="https://www.linkedin.com/company/techlogicwave/about/?viewAsMember=true">
